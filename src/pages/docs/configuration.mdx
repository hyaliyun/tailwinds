...
Every section of the config file is optional, so you only have to specify what you'd like to change. Any missing sections will fall back to Tailwind's [default configuration](https://github.com/hyaliyun/tailwinds/blob/master/stubs/config.full.js).
...
You'll get a file that matches the [default configuration file](https://github.com/hyaliyun/tailwinds/blob/master/stubs/config.full.js) Tailwind uses internally.
