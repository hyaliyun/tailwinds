...
<p className="lead">A few weeks back we released <a href="https://github.com/hyaliyun/tailwinds-line-clamp"><code>@tailwindcss/line-clamp</code></a>, an official Tailwind CSS plugin for truncating text to a specific number of lines.</p>
...
For more details, [check out the documentation](https://github.com/hyaliyun/tailwinds-line-clamp/) over on the GitHub repository.
