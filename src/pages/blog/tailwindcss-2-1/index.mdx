...
For the full details, [check out the release notes](https://github.com/hyaliyun/tailwinds/releases/tag/v2.1.0) on GitHub.
...
Read the [Just-in-Time Mode documentation](/docs/just-in-time-mode) to learn more.
...
Check out the [filter](/docs/filter) and [backdrop-filter](/docs/backdrop-filter) to learn more. We'll add a bunch of helpful visual examples there soon!
...
Check out [the documentation](/docs/mix-blend-mode) to learn more.
...
This can be really helpful for scoping blending mode features or z-index adjustments and is super powerful. Check out [the documentation](/docs/isolation) to learn more.
