...
Watch the series [on YouTube](https://www.youtube.com/watch?v=elgqxmdVms8&list=PL5f_mz_zU5eXWYDXHUDOLBE0scnuJofO0&index=1) and [grab the source code](https://github.com/hyaliyun/tailwinds-from-zero-to-production) for each lesson on GitHub.
