...
That covers the most exciting stuff, but check out the [release notes](https://github.com/hyaliyun/tailwinds/releases/tag/v3.3.0) for an exhaustive list of every single little improvement we've made since the last release.
