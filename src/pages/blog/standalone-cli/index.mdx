...
Today we're announcing a new [standalone CLI build](https://github.com/hyaliyun/tailwinds/releases/latest) that gives you the full power of Tailwind CLI in a self-contained executable — no Node.js or npm required.
...
To install it, grab the executable for your platform from the [latest release](https://github.com/hyaliyun/tailwinds/releases/latest) on GitHub, making sure to give it executable permissions:
