...
As always check out the [release notes](https://github.com/hyaliyun/tailwinds/releases/tag/v3.2.0) for every nitty-gritty fix and improvement, but here's the highlight reel:
...
```css {{ filename: './styles/client.css' }}
...
For complete documentation, check out the plugin [on GitHub](https://github.com/hyaliyun/tailwinds-container-queries).
