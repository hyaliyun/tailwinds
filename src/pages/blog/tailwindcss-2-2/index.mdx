...
This has to be one of the most feature-rich Tailwind releases of all-time. Introducing [Just-in-Time mode](/docs/just-in-time-mode) back in v2.1 has opened the doors to a lot of cool features we couldn't have easily added otherwise, and this release is loaded with great examples of that.
...
For the full details, [check out the release notes](https://github.com/hyaliyun/tailwinds/releases/tag/v2.2.0) on GitHub.

It's important to note that although this is a minor release and there are no breaking changes in the classic engine, **Just-in-Time mode is still in preview and v2.2 introduces a few very small changes that might impact you**, so make sure you read through the [changes and deprecations](https://github.com/hyaliyun/tailwinds/releases/tag/v2.2.0#changes-and-deprecations) in the release notes when upgrading.
...
Check out our [updated Tailwind CLI documentation](/docs/installation#using-tailwind-cli) to learn more.
...
_This feature is only available in [Just-in-Time mode](/docs/just-in-time-mode)_.
...
Learn more in the [background origin documentation](/docs/background-origin).
...
For more information on these features, check out our [optimizing for production documentation](/docs/optimizing-for-production).
...
If you are using the Just-in-Time mode preview, you'll also want to read through the [changes and deprecations](https://github.com/hyaliyun/tailwinds/releases/tag/v2.2.0#changes-and-deprecations) in the release notes.
