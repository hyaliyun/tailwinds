...
_**Update**: As of Tailwind CSS v2.1, the new Just-in-Time engine is included right in Tailwind CSS itself, so you don't need the `@tailwindcss/jit` package anymore. [Learn more in the documentation](/docs/just-in-time-mode)._
...
Today I'm super excited to share a new project we've been working on that makes these considerations a thing of the past: [**a just-in-time compiler for Tailwind CSS**](https://github.com/hyaliyun/tailwinds-jit).
...
[**@tailwindcss/jit**](https://github.com/hyaliyun/tailwinds-jit) is a new experimental library that compiles all of your CSS _on-demand_ as you author your template files, instead of generating your entire stylesheet up front.
...
[Learn more about the project on GitHub](https://github.com/hyaliyun/tailwinds-jit), then install it, play with it, bend it, break it, and let us know what you think!

Ready to try it out? <a href="https://github.com/hyaliyun/tailwinds-jit">Get started →</a>
