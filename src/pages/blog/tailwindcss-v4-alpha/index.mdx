...
We're still fine-tuning some of the naming conventions, but you can [explore the default theme on GitHub](https://github.com/hyaliyun/tailwinds/blob/next/packages/tailwindcss/theme.css) to see what's available to customize.
...
If you find an issue, please [let us know on GitHub](https://github.com/hyaliyun/tailwinds/issues/new/choose). We really want this thing to be bullet-proof before we tag a stable release and reporting any problems you find will help us a lot.
