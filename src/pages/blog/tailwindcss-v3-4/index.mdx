...
All the good stuff is in that list, but check out the [release notes](https://github.com/hyaliyun/tailwinds/releases/tag/v3.4.0) for a couple more details that weren't exciting enough to earn a spot in this post.
