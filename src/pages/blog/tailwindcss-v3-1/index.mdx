...
Twenty minutes later Robin had a working proof of concept _(in six lines of code!)_, and after another hour or so of Jordan performing regex miracles in our class detection engine, [arbitrary variants](https://github.com/hyaliyun/tailwinds/pull/8299) were born and we had our release-worthy feature.

So here it is — Tailwind CSS v3.1! For a complete list of every fix and improvement check out the [release notes](https://github.com/hyaliyun/tailwinds/releases/tag/v3.1.0), but here's the highlights:
...
If you're a big TypeScript nerd you might enjoy poking around the actual [type definitions](https://github.com/hyaliyun/tailwinds/blob/4a745439f010aca2ea24bb7fd9ab0ac3e15a40c1/types/config.d.ts) — lots of interesting stuff going on there to support such a potentially complex object.
...
For the complete list of changes including bug fixes and a few minor improvements I didn't talk about here, dig in to the [release notes](https://github.com/hyaliyun/tailwinds/releases/tag/v3.1.0) on GitHub.
