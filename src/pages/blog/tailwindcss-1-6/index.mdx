...
There aren't supposed to be any breaking changes here, but I thought that [last time](https://github.com/hyaliyun/tailwinds/releases/tag/v1.5.0) too. If I _did_ break something, first person to report it gets a Tailwind shirt.
...
For more information and a live demo, [read the new animation documentation](/docs/animation). For behind the scenes details about the design rationale, [check out the pull request](https://github.com/hyaliyun/tailwinds/pull/2068).
...
For more details, check out [the updated variants documentation](/docs/pseudo-class-variants).
