...
...and [a bunch of other little things](https://github.com/hyaliyun/tailwinds/blob/master/CHANGELOG.md) too.
...
[Check out the upgrade guide](/docs/upgrading-to-v2) for more details and step-by-step instructions on migrating your project to Tailwind CSS v2.0.
...
Learn more in the new [customizing colors documentation](/docs/customizing-colors).
...
Exciting I know but also let's be serious [you've been able to add this yourself](/docs/responsive-design#customizing-breakpoints) for like three years. Now it's blessed though, I get it.
...
The [ring width documentation](/docs/ring-width) is the best starting point for learning these new APIs. They seriously turned out so cool, more useful than you probably think.
...
I tried to solve this a while back with the [@tailwindcss/custom-forms](https://github.com/hyaliyun/tailwinds-custom-forms) plugin, but something about adding a bunch of classes like `form-input` and `form-checkbox` just didn't feel quite right so we didn't really promote it and didn't even link to it from the Tailwind documentation. This time though I think we figured it out.
...
Check out [the @tailwindcss/forms documentation](https://github.com/hyaliyun/tailwinds-forms) for more information.
...
[Giddy up](/docs/configuring-variants#enabling-extra-variants).
