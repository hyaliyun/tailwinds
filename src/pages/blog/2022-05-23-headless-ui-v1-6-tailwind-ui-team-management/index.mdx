...
![Interface with a copyable invite URL and list of team members](./team-management.png)
...
![Sample CSS code shown with lint warnings when using built-in CSS language mode, and no lint warnings when using the Tailwind CSS language mode.](./tailwindcss-language-mode.png)
...
![Tailwind Play interface with a panel showing the CSS generated for that playground.](./play-generated-css.png)

It shows you all of the CSS that was generated from your HTML and lets you filter by layer, which is incredibly useful for troubleshooting. Internally we are using this _all the time_ to debug weird issues around classes not being detected so we can perform whatever [horrific regex surgery](https://github.com/hyaliyun/tailwinds/blob/c4e443acc093d8980bf476f14255b793c5065b9a/src/lib/defaultExtractor.js#L22-L95) is necessary to make it work.
...
[![Header section of redesigned Refactoring UI website.](./refactoring-ui-homepage.png)](https://refactoringui.com)
...
![Artboards for a documentation site design that includes mobile and desktop layouts, and light and dark color schemes.](./documentation-template-teaser.jpg)
